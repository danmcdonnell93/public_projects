...
# plt.savefig("scatter_chart.png", dpi = 800)

# Initially I struggled to get my chart to sort descending by average fuel economy.
# Removed a lot of code but kept this part from my earlier attempts

# Converted some data frame columns to individual series for visualization purposes

# carBrand = fuelFED_Pivot1.index.to_series()
# averageMPG = fuelFED_Pivot1["TotalCombMPG_int"]
# pollution = fuelFED_Pivot1["Air Pollution Score"]
# greenhouse = fuelFED_Pivot1["Greenhouse Gas Score"]
# averageMPG.sort_values(ascending = False)
# greenhouse.sort_values(ascending = False)


# output_file('bokeh_mpg_graph.html')

# plot1 = figure(
#     y_range = carBrand,
#     plot_width = 1600,
#     plot_height = 900,
#     title = 'Brand Average MPG - (Higher is better)',
#     x_axis_label = 'Average MPG',
#     )
